...
### Fixed
- **Test stability** — All version assertions now derive from the `CURRENT_VERSION` constant instead of hardcoded strings, so version bumps no longer break tests
